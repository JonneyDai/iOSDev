...
#define searchTimeInterval 0.5f
static int count = 0;
...
-(BOOL)bindToLocalPort:(NSInteger)localPort
{
   return [_sock bindToPort:localPort error:nil];
}
...
//    NSLog(@"UDP Sending Data %@",[[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding]);
