...
//当不数据type时，若有多个，将会提起第一个保存的socket
...
- (GETCPSocket *)cloneTcpSocketMap:(NSString *)mapId andType:(GETCPType)type;//cloneSocket映像

- (GEUDPSocket *)cloneUdpSocketMap:(NSString *)mapId;//cloneSocket映像
