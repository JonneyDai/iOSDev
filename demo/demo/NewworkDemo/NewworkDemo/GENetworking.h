...
- (GEUDPSocket *) creatUdpWithDAO:(id <RTSocketDAO>)dao withIpAndPortContext:(NSDictionary *)context withDelegate:(id)delegate;  //普通UDP

- (GEUDPSocket *) creatUdpBroadCastWithDAO:(id<RTSocketDAO>)dao withDelegate:(id)delegate;  //专为broadcast定制
