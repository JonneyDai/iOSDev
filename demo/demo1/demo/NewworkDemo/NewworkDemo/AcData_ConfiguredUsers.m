...
#import "AcData_ConfiguredUsers.h"
#import "DeviceData.h"
#import "DeviceNetWork.h"

@implementation AcData_ConfiguredUsers
...
-(int)TcpNwkBuildPacketFrame:(unsigned char *)Buf
{
    ...
    NSString *name = mDeviceData->LoginName;
    //NSLog(@"name %@",name);
    Temp = [self FillPacketWithString:name Buffer:Bufptr];
    Bufptr += Temp;
    len += Temp;
    
    NSString *PassWord = mDeviceData->LoginPassword;
