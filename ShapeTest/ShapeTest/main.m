...
//@interface OblateSphereoids : NSObject
//{
//    ShapeColor fillColor;
//    ShapeRect bounds;
//}
...
//-(void) draw;
//
//@end //OblateSphereoids
//
//@implementation OblateSphereoids
//
//-(void)setFillColor:(ShapeColor)c
//{
//    fillColor = c;
...
//-(void)draw
//{
//    NSLog(@"drawing a oblateSphereoids at (%d %d %d %d) in %@",bounds.x,bounds.y,bounds.width,bounds.height,colorName(fillColor));
//} //draw
//
//@end  //OblateSphereoids
//
...
int main (int argc, const char * argv[])
{
    ...
    shapes[0] = [Circle new];
    [shapes[0] setBounds: rect0];
    [shapes[0] setFil lColor: kRedColor];
