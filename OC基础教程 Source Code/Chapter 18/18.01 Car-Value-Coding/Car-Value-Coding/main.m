...
//        //setValueforKey
//        [car setValue:@"Harold" forKey:@"name"];
//        NSLog(@"name is %@",[car valueForKey:@"name"]);
//        [car setValue:[NSNumber numberWithFloat:2506.9] forKey:@"mileage"];
//        NSLog(@"mileage is %@",[car valueForKey:@"mileage"]);
//
//        NSLog(@"horsepower is %@",[engine valueForKey:@"horsepower"]);
...
//        NSLog(@"horsepower is %@",[car valueForKeyPath:@"engine.horsepower"]);
        ...
        NSArray *pressures = [car valueForKeyPath:@"tires.pressure"];
        NSLog(@"pressure is %@",pressures);
        
        
        NSLog(@"tires is %@",[car valueForKeyPath:@"tires.treadDepth"]);
	}
