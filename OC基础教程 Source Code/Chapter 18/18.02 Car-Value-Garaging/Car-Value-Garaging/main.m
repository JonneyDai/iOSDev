...
//        NSArray *manufacturers;
//        manufacturers = [garage valueForKeyPath:@"cars.@distinctUnionOfObjects.make"];
//        NSLog(@"maker:%@",manufacturers);
        
        car = [garage valueForKey:@"cars"];
        NSLog(@"cars:%@",car);
        
        car = [[garage valueForKey:@"cars"]lastObject];
        NSArray *keys = [NSArray arrayWithObjects:@"name",@"make",@"model",@"modelYear",nil];
        NSDictionary *carValues = [car dictionaryWithValuesForKeys:keys];
        NSLog(@"car values: %@",carValues);
        
        NSDictionary *newValues = [NSDictionary dictionaryWithObjectsAndKeys:@"Cheny",@"make",@"Nova",@"model",[NSNumber numberWithInt:1964],@"modelYear", nil];
        [car setValuesForKeysWithDictionary:newValues];
        NSLog(@"car with new values is %@",car);
